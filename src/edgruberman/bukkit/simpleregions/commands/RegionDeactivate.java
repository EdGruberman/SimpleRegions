...
public class RegionDeactivate implements CommandExecutor {
    ...
    public RegionDeactivate(final Plugin plugin, final Catalog catalog) {
        this.plugin = plugin;
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        MessageManager.of(this.plugin).tell(sender, String.format("§eDeactivated§r region %1$s in %2$s", region.getDisplayName(), (region.world != null ? region.world.getName() : Region.SERVER_DEFAULT_DISPLAY)), MessageLevel.STATUS);
         return true;
    }
